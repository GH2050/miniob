...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SUM_F = 4,                      /* SUM_F  */
  YYSYMBOL_MIN_F = 5,                      /* MIN_F  */
  YYSYMBOL_MAX_F = 6,                      /* MAX_F  */
  YYSYMBOL_COUNT_F = 7,                    /* COUNT_F  */
  YYSYMBOL_AVG_F = 8,                      /* AVG_F  */
  ...
  YYSYMBOL_aggr_op = 92,                   /* aggr_op  */
  YYSYMBOL_rel_attr_aggr = 93,             /* rel_attr_aggr  */
  YYSYMBOL_rel_attr_aggr_list = 94,        /* rel_attr_aggr_list  */
...
static const yytype_int16 yyrline[] =
{
     ...
     259,   265,   273,   287,   297,   317,   320,   333,   341,   351,
     354,   355,   356,   357,   360,   377,   380,   391,   395,   399,
     404,   412,   424,   439,   461,   471,   476,   487,   490,   493,
     496,   499,   503,   506,   514,   521,   533,   538,   545,   554,
     569,   570,   571,   572,   573,   577,   584,   589,   600,   603,
     617,   620,   634,   637,   650,   653,   659,   662,   667,   674,
     686,   698,   710,   725,   726,   727,   728,   729,   730,   734,
     747,   755,   765,   766
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "SEMICOLON", "SUM_F",
  "MIN_F", "MAX_F", "COUNT_F", "AVG_F", "CREATE", "DROP", "TABLE",
  ...
  "aggr_op", "rel_attr_aggr", "rel_attr_aggr_list", "attr_list",
...
{
      71,    11,    21,    72,    -2,   -36,    27,  -111,    19,    10,
       1,  -111,  -111,  -111,  -111,  -111,     5,   -10,    71,    61,
      76,  -111,  -111,  -111,  -111,  -111,  -111,  -111,  -111,  -111,
    -111,  -111,  -111,  -111,  -111,  -111,  -111,  -111,  -111,  -111,
    -111,    28,    38,    40,    44,    72,  -111,  -111,  -111,  -111,
      72,  -111,  -111,    12,  -111,  -111,  -111,  -111,  -111,    48,
    -111,    63,    78,    79,  -111,  -111,    54,    55,    74,    66,
      73,  -111,  -111,  -111,  -111,    93,    80,  -111,    81,     8,
    -111,    72,    72,    72,    72,    72,    64,    65,     3,  -111,
       0,    82,    85,    83,   -38,    75,    84,    86,    87,  -111,
    -111,   -22,   -22,  -111,  -111,  -111,   103,    78,  -111,    95,
    -111,   108,   111,    22,  -111,    88,  -111,   100,    77,   112,
     115,  -111,    89,    85,  -111,    90,   -34,   117,   -38,    -5,
      -5,  -111,   104,   -38,   135,  -111,  -111,  -111,  -111,   125,
      84,   126,    98,   103,  -111,  -111,   108,  -111,   124,  -111,
    -111,  -111,  -111,  -111,  -111,    22,    22,    22,    85,    99,
     105,   112,  -111,   127,  -111,  -111,   -38,   132,  -111,  -111,
    -111,  -111,  -111,  -111,  -111,  -111,   133,  -111,  -111,   124,
    -111,  -111,  -111
};
...
static const yytype_int8 yydefact[] =
{
     ...
     102,    22,    21,    14,    15,    16,    17,     9,    10,    11,
      ...
      20,     0,     0,     0,     0,     0,    47,    48,    50,    49,
       0,    63,    54,    55,    70,    71,    72,    73,    74,    66,
      64,     0,    80,     0,    31,    30,     0,     0,     0,     0,
       0,   100,     1,   103,     2,     0,     0,    29,     0,     0,
      62,     0,     0,     0,     0,     0,     0,     0,     0,    65,
       0,     0,    84,     0,     0,     0,     0,     0,     0,    61,
      56,    57,    58,    59,    60,    67,    82,    80,    69,    76,
      75,    78,     0,    86,    51,     0,   101,     0,     0,    35,
       0,    33,     0,    84,    81,     0,     0,     0,     0,     0,
       0,    85,    87,     0,     0,    40,    41,    42,    43,    38,
       0,     0,     0,    82,    53,    77,    78,    68,    45,    93,
      94,    95,    96,    97,    98,     0,     0,    86,    84,     0,
       0,    35,    34,     0,    83,    79,     0,     0,    90,    92,
      89,    91,    88,    52,    99,    39,     0,    36,    32,    45,
      44,    37,    46
};
...
static const yytype_int16 yypgoto[] =
{
    ...
    -111,  -111,  -111,  -111,  -111,    -1,    23,  -111,  -111,  -111,
     -20,   -93,  -111,  -111,  -111,  -111,    91,   -33,  -111,    -4,
    -111,    35,    16,    57,    24,  -110,     9,  -111,    39,  -111,
    -111,  -111,  -111
};
...
static const yytype_uint8 yydefgoto[] =
{
      ...
      28,    29,    30,    31,    32,   141,   119,   176,   139,    33,
     167,    51,    34,    35,    36,    37,    52,    53,    61,   130,
      63,   111,   127,    89,   123,   114,   131,   132,   155,    38,
      39,    40,    74
};
...
{
      62,   116,    54,    55,    56,    57,    58,    54,    55,    56,
      57,    58,    79,   144,    46,    47,    48,    80,    49,    64,
     129,   109,    41,   108,    42,   110,    54,    55,    56,    57,
      58,    99,    43,    70,    44,   148,    81,    84,    85,    65,
     158,   149,   150,   151,   152,   153,   154,    67,   173,   101,
     102,   103,   104,    59,    66,   109,    68,    60,    59,   110,
      69,    72,   168,   170,   129,    82,    83,    84,    85,    82,
      83,    84,    85,   179,    46,    47,    48,    59,    49,    73,
       1,     2,    86,    75,   107,     3,     4,     5,     6,     7,
       8,     9,    10,    76,    45,    77,    11,    12,    13,    78,
      87,    90,    88,    14,    15,   135,   136,   137,   138,    91,
      92,    16,    94,    17,    93,    96,    18,    95,   112,   105,
     106,    97,    98,   113,    46,    47,    48,   122,    49,   125,
      50,   117,   126,   128,   133,   134,   140,   142,   115,   118,
     147,   120,   121,   157,   143,   145,   159,   160,   166,   162,
     178,   169,   171,   163,   174,   180,   181,   175,    71,   182,
     177,   146,   165,   161,   124,     0,   172,   164,     0,   156,
       0,     0,   100
};

static const yytype_int16 yycheck[] =
{
       4,    94,     4,     5,     6,     7,     8,     4,     5,     6,
       7,     8,    45,   123,    52,    53,    54,    50,    56,    55,
     113,    55,    11,    23,    13,    59,     4,     5,     6,     7,
       8,    23,    11,    43,    13,   128,    24,    59,    60,    12,
     133,    46,    47,    48,    49,    50,    51,    37,   158,    82,
      83,    84,    85,    55,    35,    55,    55,    59,    55,    59,
      55,     0,   155,   156,   157,    57,    58,    59,    60,    57,
      58,    59,    60,   166,    52,    53,    54,    55,    56,     3,
       9,    10,    34,    55,    88,    14,    15,    16,    17,    18,
      19,    20,    21,    55,    22,    55,    25,    26,    27,    55,
      37,    22,    24,    32,    33,    28,    29,    30,    31,    55,
      55,    40,    46,    42,    40,    22,    45,    44,    36,    55,
      55,    41,    41,    38,    52,    53,    54,    24,    56,    34,
      58,    56,    24,    22,    46,    35,    24,    22,    55,    55,
      23,    55,    55,    39,    55,    55,    11,    22,    24,    23,
      23,   155,   156,    55,    55,    23,    23,    52,    18,   179,
     161,   126,   146,   140,   107,    -1,   157,   143,    -1,   130,
      -1,    -1,    81
};
...
{
       0,     9,    10,    14,    15,    16,    17,    18,    19,    20,
      21,    25,    26,    27,    32,    33,    40,    42,    45,    63,
      64,    65,    66,    67,    68,    69,    70,    71,    72,    73,
      74,    75,    76,    81,    84,    85,    86,    87,   101,   102,
     103,    11,    13,    11,    13,    22,    52,    53,    54,    56,
      58,    83,    88,    89,     4,     5,     6,     7,     8,    55,
      59,    90,    91,    92,    55,    12,    35,    37,    55,    55,
      43,    64,     0,     3,   104,    55,    55,    55,    55,    89,
      89,    24,    57,    58,    59,    60,    34,    37,    24,    95,
      22,    55,    55,    40,    46,    44,    22,    41,    41,    23,
      88,    89,    89,    89,    89,    55,    55,    91,    23,    55,
      59,    93,    36,    38,    97,    55,    83,    56,    55,    78,
      55,    55,    24,    96,    95,    34,    24,    94,    22,    83,
      91,    98,    99,    46,    35,    28,    29,    30,    31,    80,
      24,    77,    22,    55,    97,    55,    93,    23,    83,    46,
      47,    48,    49,    50,    51,   100,   100,    39,    83,    11,
      22,    78,    23,    55,    96,    94,    24,    82,    83,    91,
      83,    91,    98,    97,    55,    52,    79,    77,    23,    83,
      23,    23,    82
};
...
#line 2217 "yacc_sql.cpp"
  ...
  case 68: /* rel_attr: aggr_op LBRACE rel_attr_aggr rel_attr_aggr_list RBRACE  */
#line 545 "yacc_sql.y"
                                                            { //my2
...
#line 2231 "yacc_sql.cpp"
  ...
  case 69: /* rel_attr: aggr_op LBRACE RBRACE  */
#line 554 "yacc_sql.y"
                           {
      (yyval.rel_attr) = new RelAttrSqlNode;
...
#line 2244 "yacc_sql.cpp"
  ...
  case 70: /* aggr_op: SUM_F  */
#line 569 "yacc_sql.y"
         { (yyval.aggr) = AGGR_SUM; }
#line 2250 "yacc_sql.cpp"
    break;

  case 71: /* aggr_op: MIN_F  */
#line 570 "yacc_sql.y"
          { (yyval.aggr) = AGGR_MIN; }
#line 2256 "yacc_sql.cpp"
    break;

  case 72: /* aggr_op: MAX_F  */
#line 571 "yacc_sql.y"
          { (yyval.aggr) = AGGR_MAX; }
#line 2262 "yacc_sql.cpp"
    break;

  case 73: /* aggr_op: COUNT_F  */
#line 572 "yacc_sql.y"
            { (yyval.aggr) = AGGR_COUNT; }
#line 2268 "yacc_sql.cpp"
    break;

  case 74: /* aggr_op: AVG_F  */
#line 573 "yacc_sql.y"
          { (yyval.aggr) = AGGR_AVG; }
#line 2274 "yacc_sql.cpp"
    break;

  case 75: /* rel_attr_aggr: '*'  */
#line 577 "yacc_sql.y"
        {
      (yyval.rel_attr) = new RelAttrSqlNode;
      (yyval.rel_attr)->relation_name  = "";
...
#line 2296 "yacc_sql.cpp"
  ...
  case 77: /* rel_attr_aggr: ID DOT ID  */
#line 589 "yacc_sql.y"
                {
      (yyval.rel_attr) = new RelAttrSqlNode;
      (yyval.rel_attr)->relation_name  = (yyvsp[-2].string);
...
#line 2308 "yacc_sql.cpp"
  ...
  case 78: /* rel_attr_aggr_list: %empty  */
#line 600 "yacc_sql.y"
    {
...
#line 2316 "yacc_sql.cpp"
  ...
  case 79: /* rel_attr_aggr_list: COMMA rel_attr_aggr rel_attr_aggr_list  */
#line 603 "yacc_sql.y"
                                             {
      if ((yyvsp[0].rel_attr_list) != nullptr) {
        (yyval.rel_attr_list) = (yyvsp[0].rel_attr_list);
