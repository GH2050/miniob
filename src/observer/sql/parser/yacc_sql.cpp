...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_JOIN = 5,                       /* JOIN  */
  YYSYMBOL_SUM_F = 6,                      /* SUM_F  */
  YYSYMBOL_MIN_F = 7,                      /* MIN_F  */
  YYSYMBOL_MAX_F = 8,                      /* MAX_F  */
  YYSYMBOL_COUNT_F = 9,                    /* COUNT_F  */
  YYSYMBOL_AVG_F = 10,                     /* AVG_F  */
  ...
  YYSYMBOL_join_list = 89,                 /* join_list  */
  ...
  YYSYMBOL_aggr_op = 95,                   /* aggr_op  */
  YYSYMBOL_rel_attr_aggr = 96,             /* rel_attr_aggr  */
  YYSYMBOL_rel_attr_aggr_list = 97,        /* rel_attr_aggr_list  */
...
static const yytype_int16 yyrline[] =
{
     ...
     263,   269,   277,   291,   301,   321,   324,   337,   345,   355,
     358,   359,   360,   361,   364,   381,   384,   395,   399,   403,
     408,   416,   428,   465,   495,   498,   501,   520,   530,   535,
     546,   549,   552,   555,   558,   562,   565,   573,   580,   592,
     597,   604,   613,   628,   629,   630,   631,   632,   636,   643,
     648,   659,   662,   676,   679,   693,   696,   709,   712,   718,
     721,   726,   733,   745,   757,   769,   784,   785,   786,   787,
     788,   789,   793,   806,   814,   824,   825
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "SEMICOLON", "INNER",
  "JOIN", "SUM_F", "MIN_F", "MAX_F", "COUNT_F", "AVG_F", "CREATE", "DROP",
  "TABLE", "TABLES", "INDEX", "CALC", "SELECT", "DESC", "SHOW", "SYNC",
  "INSERT", "DELETE", "UPDATE", "LBRACE", "RBRACE", "COMMA", "TRX_BEGIN",
  "TRX_COMMIT", "TRX_ROLLBACK", "INT_T", "STRING_T", "FLOAT_T", "DATE_T",
  "HELP", "EXIT", "DOT", "INTO", "VALUES", "FROM", "WHERE", "AND", "SET",
  "ON", "LOAD", "DATA", "INFILE", "EXPLAIN", "EQ", "LT", "GT", "LE", "GE",
  "NE", "NUMBER", "FLOAT", "DATE_STR", "ID", "SSS", "'+'", "'-'", "'*'",
  ...
  "rel_attr", "aggr_op", "rel_attr_aggr", "rel_attr_aggr_list",
...
{
      76,    14,    24,    -7,    -3,   -47,    12,  -151,     1,    -6,
     -16,  -151,  -151,  -151,  -151,  -151,    -5,    22,    76,    57,
      71,  -151,  -151,  -151,  -151,  -151,  -151,  -151,  -151,  -151,
    -151,  -151,  -151,  -151,  -151,  -151,  -151,  -151,  -151,  -151,
    -151,    23,    26,    28,    32,    -7,  -151,  -151,  -151,  -151,
      -7,  -151,  -151,    47,  -151,  -151,  -151,  -151,  -151,    45,
    -151,    61,    75,    66,  -151,  -151,    62,    65,    60,    73,
      82,  -151,  -151,  -151,  -151,   105,    87,  -151,    88,   -17,
    -151,    -7,    -7,    -7,    -7,    -7,    77,    78,    15,  -151,
      25,    95,    92,    79,    21,    80,    83,    84,    85,  -151,
    -151,   -43,   -43,  -151,  -151,  -151,   111,    75,  -151,   103,
    -151,   117,   120,     5,  -151,    97,  -151,   109,    94,   121,
     124,  -151,    93,    51,  -151,    98,   -29,   126,    21,    64,
      64,  -151,   108,    21,   139,  -151,  -151,  -151,  -151,   132,
      83,   133,   100,   111,    51,   102,    92,  -151,   117,  -151,
     134,  -151,  -151,  -151,  -151,  -151,  -151,     5,     5,     5,
      92,   104,   110,   121,  -151,   137,  -151,  -151,   122,  -151,
    -151,    21,   138,  -151,  -151,  -151,  -151,  -151,  -151,  -151,
    -151,   141,  -151,  -151,     5,   134,  -151,  -151,    51,  -151,
    -151
};
...
static const yytype_int8 yydefact[] =
{
     ...
     105,    22,    21,    14,    15,    16,    17,     9,    10,    11,
      ...
      20,     0,     0,     0,     0,     0,    47,    48,    50,    49,
       0,    66,    57,    58,    73,    74,    75,    76,    77,    69,
      67,     0,    83,     0,    31,    30,     0,     0,     0,     0,
       0,   103,     1,   106,     2,     0,     0,    29,     0,     0,
      65,     0,     0,     0,     0,     0,     0,     0,     0,    68,
       0,     0,    87,     0,     0,     0,     0,     0,     0,    64,
      59,    60,    61,    62,    63,    70,    85,    83,    72,    79,
      78,    81,     0,    89,    51,     0,   104,     0,     0,    35,
       0,    33,     0,    54,    84,     0,     0,     0,     0,     0,
       0,    88,    90,     0,     0,    40,    41,    42,    43,    38,
       0,     0,     0,    85,    54,     0,    87,    80,    81,    71,
      45,    96,    97,    98,    99,   100,   101,     0,     0,    89,
      87,     0,     0,    35,    34,     0,    86,    55,     0,    53,
      82,     0,     0,    93,    95,    92,    94,    91,    52,   102,
      39,     0,    36,    32,    89,    45,    44,    37,    54,    46,
      56
};
...
{
    -151,  -151,   149,  -151,  -151,  -151,  -151,  -151,  -151,  -151,
    -151,  -151,  -151,  -151,  -151,     6,    30,  -151,  -151,  -151,
     -13,   -93,  -151,  -151,  -151,  -142,  -151,    90,   -14,  -151,
      -4,  -151,    42,    27,    67,    33,  -130,  -150,  -151,    43,
    -151,  -151,  -151,  -151
};
...
static const yytype_uint8 yydefgoto[] =
{
      ...
      28,    29,    30,    31,    32,   141,   119,   181,   139,    33,
     172,    51,    34,    35,    36,   146,    37,    52,    53,    61,
     130,    63,   111,   127,    89,   123,   114,   131,   132,   157,
      38,    39,    40,    74
};
...
{
      62,   116,   167,    54,    55,    56,    57,    58,    99,   177,
      64,    54,    55,    56,    57,    58,   169,    45,    84,    85,
     129,    54,    55,    56,    57,    58,    65,    41,   109,    42,
     178,    79,   110,    67,   188,   150,    80,    43,    66,    44,
     160,    68,    82,    83,    84,    85,   190,    46,    47,    48,
     108,    49,    69,    50,    59,   144,   145,    72,    60,    46,
      47,    48,    59,    49,   173,   175,   129,    70,   101,   102,
     103,   104,    59,    81,    73,    46,    47,    48,   185,    49,
      75,    86,   109,    76,   107,    77,   110,     1,     2,    78,
      90,   129,     3,     4,     5,     6,     7,     8,     9,    10,
      87,    88,    93,    11,    12,    13,    82,    83,    84,    85,
      14,    15,   151,   152,   153,   154,   155,   156,    16,    91,
      17,    94,    92,    18,   135,   136,   137,   138,    95,    96,
      97,    98,   113,   112,   105,   106,   115,   122,   117,   125,
     118,   120,   121,   126,   128,   133,   134,   140,   142,   159,
     143,   149,   161,   174,   176,   147,   162,   165,   164,   168,
     171,   179,   183,   186,   180,   184,   187,    71,   148,   182,
     163,   100,   189,   158,   124,   170,   166
};

static const yytype_uint8 yycheck[] =
{
       4,    94,   144,     6,     7,     8,     9,    10,    25,   159,
      57,     6,     7,     8,     9,    10,   146,    24,    61,    62,
     113,     6,     7,     8,     9,    10,    14,    13,    57,    15,
     160,    45,    61,    39,   184,   128,    50,    13,    37,    15,
     133,    57,    59,    60,    61,    62,   188,    54,    55,    56,
      25,    58,    57,    60,    57,     4,     5,     0,    61,    54,
      55,    56,    57,    58,   157,   158,   159,    45,    82,    83,
      84,    85,    57,    26,     3,    54,    55,    56,   171,    58,
      57,    36,    57,    57,    88,    57,    61,    11,    12,    57,
      24,   184,    16,    17,    18,    19,    20,    21,    22,    23,
      39,    26,    42,    27,    28,    29,    59,    60,    61,    62,
      34,    35,    48,    49,    50,    51,    52,    53,    42,    57,
      44,    48,    57,    47,    30,    31,    32,    33,    46,    24,
      43,    43,    40,    38,    57,    57,    57,    26,    58,    36,
      57,    57,    57,    26,    24,    48,    37,    26,    24,    41,
      57,    25,    13,   157,   158,    57,    24,    57,    25,    57,
      26,    57,    25,    25,    54,    43,    25,    18,   126,   163,
     140,    81,   185,   130,   107,   148,   143
};
...
static const yytype_int8 yystos[] =
{
      ...
      23,    27,    28,    29,    34,    35,    42,    44,    47,    65,
      66,    67,    68,    69,    70,    71,    72,    73,    74,    75,
      76,    77,    78,    83,    86,    87,    88,    90,   104,   105,
     106,    13,    15,    13,    15,    24,    54,    55,    56,    58,
      60,    85,    91,    92,     6,     7,     8,     9,    10,    57,
      61,    93,    94,    95,    57,    14,    37,    39,    57,    57,
      45,    66,     0,     3,   107,    57,    57,    57,    57,    92,
      92,    26,    59,    60,    61,    62,    36,    39,    26,    98,
      24,    57,    57,    42,    48,    46,    24,    43,    43,    25,
      91,    92,    92,    92,    92,    57,    57,    94,    25,    57,
      61,    96,    38,    40,   100,    57,    85,    58,    57,    80,
      57,    57,    26,    99,    98,    36,    26,    97,    24,    85,
      94,   101,   102,    48,    37,    30,    31,    32,    33,    82,
      26,    79,    24,    57,     4,     5,    89,    57,    96,    25,
      85,    48,    49,    50,    51,    52,    53,   103,   103,    41,
      85,    13,    24,    80,    25,    57,    99,    89,    57,   100,
      97,    26,    84,    85,    94,    85,    94,   101,   100,    57,
      54,    81,    79,    25,    43,    85,    25,    25,   101,    84,
      89
};
...
#line 2098 "yacc_sql.cpp"
  ...
  case 55: /* join_list: INNER join_list  */
#line 498 "yacc_sql.y"
                      {
...
#line 2106 "yacc_sql.cpp"
  ...
  case 56: /* join_list: JOIN ID ON condition_list join_list  */
#line 501 "yacc_sql.y"
                                          {
...
#line 2268 "yacc_sql.cpp"
  ...
  case 71: /* rel_attr: aggr_op LBRACE rel_attr_aggr rel_attr_aggr_list RBRACE  */
#line 604 "yacc_sql.y"
                                                            { //my2
...
#line 2282 "yacc_sql.cpp"
  ...
  case 72: /* rel_attr: aggr_op LBRACE RBRACE  */
#line 613 "yacc_sql.y"
                           {
      (yyval.rel_attr) = new RelAttrSqlNode;
...
#line 2295 "yacc_sql.cpp"
  ...
  case 73: /* aggr_op: SUM_F  */
#line 628 "yacc_sql.y"
         { (yyval.aggr) = AGGR_SUM; }
#line 2301 "yacc_sql.cpp"
    break;

  case 74: /* aggr_op: MIN_F  */
#line 629 "yacc_sql.y"
          { (yyval.aggr) = AGGR_MIN; }
#line 2307 "yacc_sql.cpp"
    break;

  case 75: /* aggr_op: MAX_F  */
#line 630 "yacc_sql.y"
          { (yyval.aggr) = AGGR_MAX; }
#line 2313 "yacc_sql.cpp"
    break;

  case 76: /* aggr_op: COUNT_F  */
#line 631 "yacc_sql.y"
            { (yyval.aggr) = AGGR_COUNT; }
#line 2319 "yacc_sql.cpp"
    break;

  case 77: /* aggr_op: AVG_F  */
#line 632 "yacc_sql.y"
          { (yyval.aggr) = AGGR_AVG; }
#line 2325 "yacc_sql.cpp"
    break;

  case 78: /* rel_attr_aggr: '*'  */
#line 636 "yacc_sql.y"
        {
      (yyval.rel_attr) = new RelAttrSqlNode;
      (yyval.rel_attr)->relation_name  = "";
...
#line 2347 "yacc_sql.cpp"
  ...
  case 80: /* rel_attr_aggr: ID DOT ID  */
#line 648 "yacc_sql.y"
                {
      (yyval.rel_attr) = new RelAttrSqlNode;
      (yyval.rel_attr)->relation_name  = (yyvsp[-2].string);
...
#line 2359 "yacc_sql.cpp"
  ...
  case 81: /* rel_attr_aggr_list: %empty  */
#line 659 "yacc_sql.y"
    {
...
#line 2367 "yacc_sql.cpp"
  ...
  case 82: /* rel_attr_aggr_list: COMMA rel_attr_aggr rel_attr_aggr_list  */
#line 662 "yacc_sql.y"
                                             {
      if ((yyvsp[0].rel_attr_list) != nullptr) {
        (yyval.rel_attr_list) = (yyvsp[0].rel_attr_list);
